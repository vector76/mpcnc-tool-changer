...
time /T
%OPENSCAD% tool_changer.scad -D "part=""wire_string_link""" -D double_cleat=1 -o ../STLs/tc2_wire_string_link.stl
%OPENSCAD% tool_changer.scad -D "part=""drill_guide""" -D double_cleat=1 -o ../STLs/tc2_drill_guide.stl
%OPENSCAD% tool_changer.scad -D "part=""plate_a""" -D double_cleat=1 -o ../STLs/tc2_plate_a.stl
%OPENSCAD% tool_changer.scad -D "part=""plate_b""" -D double_cleat=1 -o ../STLs/tc2_plate_b.stl
%OPENSCAD% tool_changer.scad -D "part=""tool_plate""" -D double_cleat=1 -o ../STLs/tc2_tool_plate.stl
%OPENSCAD% tool_changer.scad -D "part=""pulley""" -D double_cleat=1 -o ../STLs/tc2_pulley.stl
%OPENSCAD% tool_changer.scad -D "part=""servo_bracket""" -D double_cleat=1 -o ../STLs/tc2_servo_bracket.stl
%OPENSCAD% tool_changer.scad -D "part=""back_plate""" -D double_cleat=1 -o ../STLs/tc2_back_plate.stl
